...
Detector::Detector()
{
    ...
    det_net_ptr->load_param("/home/wpr/code/pre_research/dete_ncnn_3d/include/ncnn/model/mobilenetv2_ssdlite_voc.param");
    det_net_ptr->load_model("/home/wpr/code/pre_research/dete_ncnn_3d/include/ncnn/model/mobilenetv2_ssdlite_voc.bin");
}
...
void Detector::Show(const cv::Mat& bgr_img, std::vector<Object>& objects)
{
    ...
    for (size_t i = 0; i < objects.size(); i++)
    {
       ...
       //         obj.rect.x, obj.rect.y, obj.rect.width, obj.rect.height);
        ...
        //cv::rectangle(image, obj.rect, cv::Scalar(0, 0, 255), -1, 4); // 填充的矩形框
