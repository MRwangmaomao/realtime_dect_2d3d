 ...
 * @LastEditTime : 2019-12-28 23:36:48
 * @LastEditors  : Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /dete_ncnn_3d/src/main.cpp
 */
#include <sys/time.h>
#include <unistd.h>
#include <iostream>
...
#include "ncnn_dect.h"// 目标检测
#include "XYZRGBPCViewer.hpp"// 点云显示
#include "2d_3d_merge.h"   // 2d 3d融合  Merge
#include "mergeSG.h"       // 点云分割聚类 后 融合2d  MergeSG
...
int main(){
    ...
    cv::imshow("1",img);
    cvWaitKey(0);
    pcl::PointCloud<pcl::PointXYZRGB>::Ptr point_ptr(new pcl::PointCloud<pcl::PointXYZRGB>());
